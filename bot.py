...
def _build_blocked_signal_resolution_record(signal: dict, market: dict, prices, now) -> dict:
    ...
    return {
        ...
        "signals_generated_at": signal.get("signals_generated_at") or signal.get("generated") or None,
        "trader_win_rate_source": signal.get("trader_win_rate_source") or "unknown",
        "trader_win_rate_closed_positions_count": signal.get("trader_win_rate_closed_positions_count"),
        "trader_win_rate_asof_method": signal.get("trader_win_rate_asof_method") or "unknown",
        "trader_win_rate_cutoff_at": signal.get("trader_win_rate_cutoff_at") or "unknown",
        "trader_win_rate_leakage_status": signal.get("trader_win_rate_leakage_status") or "unknown",
        "outcome": outcome,
