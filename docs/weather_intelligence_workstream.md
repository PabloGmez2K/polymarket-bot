...
| Outcome Resolver v1 design | `DESIGN_APPROVED_CODE_BLOCKED_UNTIL_T7_AND_PABLO_SIGNOFF` | Alto — cierra loop Pre-Edge → P&L contrafactual | Bajo | **DESIGN_APPROVED (S391, Opus)** — CODE bloqueado hasta T+7d sano (~2026-05-31) + autorización Pablo. Docs: [docs/outcome_resolver_v1_design.md](outcome_resolver_v1_design.md). Gate R2: R1 ≥7d LOG_ONLY limpio antes de R2. | Ver docs/outcome_resolver_v1_design.md §9 |
...
4. ~~**Outcome Resolver v1 design**~~ **DONE** — `DESIGN_APPROVED_CODE_BLOCKED_UNTIL_T7_AND_PABLO_SIGNOFF` (S391). Ver [`docs/outcome_resolver_v1_design.md`](outcome_resolver_v1_design.md). CODE bloqueado hasta T+7d sano + autorización Pablo. Gate R2: R1 ≥7d LOG_ONLY limpio.
